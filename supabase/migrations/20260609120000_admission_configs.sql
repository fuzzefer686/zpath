...
--
-- Stores one "admission config" (a JSON description of how to score a school's
-- admission for a given year) per school + year + version. New schools added
-- from a PDF live here as data; an admin must publish a config before its
-- calculator appears on the main site. Also creates a private storage bucket
-- for the source PDF files.
-- ============================================================================
