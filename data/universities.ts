...
export const UNIVERSITIES: University[] = [
  ...
  },
  {
    ...
    programs: [
      { name: "Công nghệ thông tin", majorCode: "CN1", programCode: "CN1", admissionScore2025: 28.19, tuitionPerSemester: 16.25 },
      { name: "Kỹ thuật máy tính", majorCode: "CN2", programCode: "CN2", admissionScore2025: 27.00, tuitionPerSemester: 16.25 },
      { name: "Vật lý kỹ thuật", majorCode: "CN3", programCode: "CN3", admissionScore2025: 25.20, tuitionPerSemester: 16.25 },
      { name: "Cơ kỹ thuật", majorCode: "CN4", programCode: "CN4", admissionScore2025: 26.15, tuitionPerSemester: 16.25 },
      { name: "Công nghệ kỹ thuật xây dựng", majorCode: "CN5", programCode: "CN5", admissionScore2025: 22.25, tuitionPerSemester: 16.25 },
      { name: "Công nghệ kỹ thuật cơ điện tử", majorCode: "CN6", programCode: "CN6", admissionScore2025: 26.73, tuitionPerSemester: 16.25 },
      { name: "Công nghệ hàng không vũ trụ", majorCode: "CN7", programCode: "CN7", admissionScore2025: 23.96, tuitionPerSemester: 16.25 },
      { name: "Khoa học máy tính", majorCode: "CN8", programCode: "CN8", admissionScore2025: 27.86, tuitionPerSemester: 16.25 },
      { name: "Công nghệ kỹ thuật điện tử - viễn thông", majorCode: "CN9", programCode: "CN9", admissionScore2025: 26.63, tuitionPerSemester: 16.25 },
      { name: "Công nghệ nông nghiệp", majorCode: "CN10", programCode: "CN10", admissionScore2025: 22.00, tuitionPerSemester: 16.25 },
      { name: "Kỹ thuật điều khiển và tự động hóa", majorCode: "CN11", programCode: "CN11", admissionScore2025: 27.90, tuitionPerSemester: 16.25 },
      { name: "Trí tuệ nhân tạo", majorCode: "CN12", programCode: "CN12", admissionScore2025: 27.75, tuitionPerSemester: 16.25 },
      { name: "Kỹ thuật năng lượng", majorCode: "CN13", programCode: "CN13", admissionScore2025: 24.87, tuitionPerSemester: 16.25 },
      { name: "Hệ thống thông tin", majorCode: "CN14", programCode: "CN14", admissionScore2025: 26.38, tuitionPerSemester: 16.25 },
      { name: "Mạng máy tính và truyền thông dữ liệu", majorCode: "CN15", programCode: "CN15", admissionScore2025: 26.73, tuitionPerSemester: 16.25 },
      { name: "Kỹ thuật Robot", majorCode: "CN17", programCode: "CN17", admissionScore2025: 26.00, tuitionPerSemester: 16.25 },
      { name: "Thiết kế công nghiệp và Đồ họa", majorCode: "CN18", programCode: "CN18", admissionScore2025: 24.20, tuitionPerSemester: 16.25 },
      { name: "Công nghệ vật liệu và Vi điện tử", majorCode: "CN19", programCode: "CN19", admissionScore2025: 25.60, tuitionPerSemester: 16.25 },
      { name: "Khoa học và Kỹ thuật dữ liệu", majorCode: "CN20", programCode: "CN20", admissionScore2025: 27.38, tuitionPerSemester: 16.25 },
      { name: "Công nghệ kỹ thuật sinh học", majorCode: "CN21", programCode: "CN21", admissionScore2025: 22.13, tuitionPerSemester: 16.25 }
    ],
  },
  {
    code: "HNUE",
