...
export function SbtiPicker({ value, onChange }: SbtiPickerProps) {
  ...
  return (
    <div>
      {value && (
        <div className="mb-3 flex items-center gap-2 rounded-xl bg-gradient-primary px-4 py-3 text-primary-foreground">
          <Sparkles className="h-5 w-5" />
          <span className="font-display font-bold">Bạn là: {value}</span>
        </div>
      )}
