...
import {
  ...
  HUST_ROWS,
  NEU_ROWS,
  SCORE_2026_UPDATED_AT,
  type ConfidenceTag,
} from "@/lib/score-prediction-2026";

/**
 * Full-page article for /du-doan-2026. Server component (no interactivity):
 * a methodology explainer plus three transcribed prediction tables for HUST,
 * FTU and NEU. All numbers are PREDICTIONS quoted from source reports — the
 * disclaimer stays pinned near the top per project rules.
 */
...
const CONFIG_ITEMS = [
  ...
  },
  {
    ...
    plain: "Số chỉ tiêu (N) được lấy bằng năm 2025. Nếu trường thay đổi chỉ tiêu năm 2026, điểm thực tế có thể lệch so với dự đoán.",
  },
  {
    icon: Ruler,
    term: "Biên sai số ± (MAE ngành)",
    plain: "MAE là sai số trung bình mô hình từng mắc ở ngành đó. Số càng nhỏ, dự đoán càng đáng tin. Đây là cơ sở tạo ra \"khoảng dự đoán\".",
  },
  {
    icon: Target,
  ...
  },
  {
    ...
    plain: "Một số ngành (ví dụ Ngôn ngữ Anh, có môn nhân hệ số) chấm trên thang 40. Không so trực tiếp điểm thang 40 với thang 30.",
  },
];

export function ScorePrediction2026Article() {
  return (
      ...
      <article className="container-page relative py-8 sm:py-12">
        ...
        <header className="mx-auto max-w-3xl animate-fade-up text-center">
          ...
          <div className="mt-4 inline-flex items-center gap-2 text-sm text-muted-foreground">
            ...
            Cập nhật {SCORE_2026_UPDATED_AT}
          </div>
          <div className="mt-6">
        ...
        <section className="mx-auto mt-12 max-w-3xl">
          ...
          <div className="mt-5 space-y-4 text-[15px] leading-7 text-foreground/90">
            ...
            <div className="rounded-[1.25rem] border border-primary/20 bg-primary/5 p-4">
              <p className="text-sm leading-6">
                Ví dụ: nếu điểm chuẩn 2025 nằm ở tốp <strong>2% cao nhất</strong>, thì điểm chuẩn dự
                đoán 2026 chính là mức điểm mà năm 2026 cũng chỉ có <strong>2%</strong> thí sinh đạt
                từ đó trở lên. Phương pháp này có tên khoa học là{" "}
                <strong>Equipercentile equating</strong> — bạn có thể tra cứu thêm nếu muốn tìm hiểu sâu.
              </p>
            </div>
            <p>
              ...
              một năm đã biết rồi so với thực tế. Ngành nào backtest sai số thấp thì mức tin cậy được
              đánh &ldquo;Rất cao&rdquo;; ngành đuôi nhóm hoặc từng có biến động chỉ tiêu thì tin cậy thấp hơn và
              cần dùng thận trọng.
            </p>
            <p>
          ...
          <div className="mt-6 rounded-[1.25rem] border border-border bg-background/60 p-4">
            ...
            <p className="mt-2 text-sm leading-6 text-muted-foreground">
              ...
              <strong className="text-foreground">2021–2026 (trừ 2023)</strong>. Dữ liệu công khai
              được lấy từ kho{" "}
              <a
        ...
        {/* ---------- HUST ---------- */}
        <section id="bang-diem-hust" className="mx-auto mt-14 max-w-4xl scroll-mt-24">
          <div className="flex items-center gap-3">
          ...
          <div className="mt-4">
            <TableCard>
              <thead>
                <tr>
                  <th className={thBase}>Mã ngành</th>
                  ...
                  <th className={thBase}>Cách nên dùng</th>
                </tr>
              </thead>
              <tbody>
                {HUST_ROWS.map((row) => (
                  <tr key={row.code} className="hover:bg-muted/40">
                    <td className={`${tdBase} font-bold`}>{row.code}</td>
                    ...
                    <td className={`${tdBase} text-muted-foreground`}>{row.usage}</td>
                  </tr>
                ))}
              </tbody>
            </TableCard>
          ...
          <div className="mt-4 flex gap-3 rounded-[1.25rem] border border-amber-500/40 bg-amber-500/10 p-4">
            <AlertTriangle className="mt-0.5 h-5 w-5 shrink-0 text-amber-600 dark:text-amber-400" />
            <p className="text-sm leading-6 text-foreground/90">
              <strong className="font-bold">Riêng IT-E10 cần thận trọng:</strong> năm 2026 ngành này
              tăng chỉ tiêu <strong>120 → 160</strong>, nhưng con số 29.44 vẫn tính theo kịch bản{" "}
              <code className="rounded bg-muted px-1.5 py-0.5 text-xs">quota = off</code> (neo chỉ
              tiêu từ 2025). Chỉ tiêu tăng thường kéo điểm chuẩn xuống, và mức tăng này vượt xa biên
              ±10%, nên điểm thật của IT-E10 có thể <strong>thấp hơn dự đoán</strong> — hãy để dư biên
              an toàn khi đặt nguyện vọng.
            </p>
          </div>
        </section>
        ...
        <section className="mx-auto mt-14 max-w-4xl">
          ...
          <p className="mt-2 text-sm text-muted-foreground">
            Chú ý cột &ldquo;Thang&rdquo;: hai ngành cuối chấm trên thang 40, không so trực tiếp với thang 30.
          </p>
          <div className="mt-4">
            <TableCard>
              <thead>
        ...
        <section className="mx-auto mt-14 max-w-4xl">
          ...
          <p className="mt-2 text-sm text-muted-foreground">
            Thang 30, xếp theo điểm dự đoán từ cao xuống thấp. Cột &ldquo;Tin cậy %&rdquo; càng cao càng đáng đặt.
          </p>
          <div className="mt-4">
            <TableCard>
              <thead>
